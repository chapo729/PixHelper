    ...
    return (
      <div>
         <div style={styles.divStyle}>
              ...
              <span><strong>Ev:</strong></span><DropDownMenu
            ...
            <p style={styles.rowsStyle}>
                <span><strong>Shutter:</strong></span><DropDownMenu
                  value={this.state.value}
                  onChange={this.handleChange}
                  style={styles.customWidth}
                  autoWidth={false}
                >
                  <MenuItem value={0} primaryText="1s" />
                  <MenuItem value={1} primaryText="1/2" />
                  <MenuItem value={2} primaryText="1/4" />
                  <MenuItem value={3} primaryText="1/8" />
                  <MenuItem value={4} primaryText="1/15" />
                  <MenuItem value={5} primaryText="1/30" />
                  <MenuItem value={6} primaryText="1/60" />
                  <MenuItem value={7} primaryText="1/125" />
                  <MenuItem value={8} primaryText="1/250" />
                  <MenuItem value={9} primaryText="1/500" />
                  <MenuItem value={10} primaryText="1/1000" />
                </DropDownMenu>
            </p>
            <p style={styles.rowsStyle}>
